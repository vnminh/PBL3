				...
				<div class="col-lg-5 col-xl-4">
					<c:if test="${not empty sessionScope.khachHang}">
						<ul
							...
							<li><a style="padding-top: 22px;" href="${pageContext.request.contextPath}/khach-hang/dang-xuat"
								class="nav-link text-body"> <i class="fa-solid fa-arrow-right-from-bracket d-block text-center fs-3"></i> Đăng xuất
							</a></li>
						</ul>
					</c:if>
					<c:if test="${empty sessionScope.khachHang}">
						...
						href="${pageContext.request.contextPath}/customer/signupView.jsp" role="button">
						Đăng ký </a>
							</li>
							<li>
							<a class="btn btn-primary"
						href="${pageContext.request.contextPath}/customer/signinView.jsp" role="button">
						Đăng nhập </a>
							</li>
						</ul>
					</c:if>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li onclick="showAndHideMenu()" class="nav-item dropdown"><a
